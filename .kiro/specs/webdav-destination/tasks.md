...
- [x] 1.1 Add WebDAV struct to types/types.go
...
- [x] 1.2 Add WebDAV field to Destination struct
...
- [x] 2.1 Create webdav/webdav.go package structure
...
- [x] 2.2 (P) Implement HTTP client connection handling
...
- [x] 2.3 (P) Implement authentication methods
...
- [x] 2.4 Implement WebDAV HTTP methods
...
- [x] 3.1 Create UploadDirToWebDAV function signature
...
- [x] 3.2 Implement directory walking and path conversion
...
- [x] 3.3 Implement file upload with verification
...
- [x] 3.4 Implement optional zip compression
...
- [x] 4.1 Create DeleteObjectsNotInRepo function
...
- [x] 4.2 Implement orphaned file deletion
...
- [x] 5.1 Add WebDAV destination handling in main.go
...
- [x] 5.2 Add metrics integration for WebDAV operations
...
- [x] 5.3 Implement dry-run validation mode
...
- [x] 6.5* Write end-to-end tests with real WebDAV server
